...
export default function ProjectCard({ name, image, description, technologies, sourceCode }) {
  ...
  return (
    <motion.li
      ...
      className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-600 flex flex-col transition-transform duration-300 hover:scale-105 hover:shadow-lg hover:border-purple-400 dark:hover:border-purple-500"
    >
      <img
        src={image}
